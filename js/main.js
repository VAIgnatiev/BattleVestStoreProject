/* variables */
let citylist = ['Москва и Московская область', 'Санкт-Петербург', 'Барнаул', 'Владивосток', 'Вологда', 'Екатеринбург', 'Калининград', 'Новосибирск', 'Пермь', 'Петрозаводск', 'Самара', 'Саратов', 'Тверь', 'Ярославль'];
let rangemin = 0;
let rangemax = 300;
